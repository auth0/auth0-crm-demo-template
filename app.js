...
app.get('/leads', (req, res) => res.send(leadsView));
app.get('/settings/new', (req, res) => res.send(afterView));
app.post('/email', (req,res) => console.log('email received for lead: ' + req.body.name));
